    ...
    const message = {
        ...
        html: `<div style="width: 500px; text-align: center;">
                ...
                <div style=" margin: auto; width: 100%; margin-top: 3rem; display: flex; justify-content: space-around; align-items: center; ">
                  <img src="https://imagizer.imageshack.com/img924/4680/EVMT78.png" style="width: 150px;">
                  <img src="https://imagizer.imageshack.com/img924/7997/deIQER.png" style="width: 150px;">
                </div>
              </div>`
    };
